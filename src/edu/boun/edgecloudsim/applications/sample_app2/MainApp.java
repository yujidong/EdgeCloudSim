    ...
    public static void main(String[] args) {
        ...
        for (int z = 0; z < 8; z++) {
            ...
            for (int j = SS.getMinNumOfMobileDev(); j <= SS.getMaxNumOfMobileDev(); j += SS.getMobileDevCounterSize()) {
                MobilityModel mobilityModel = new ManhattanGridMobility(j, SS.getSimulationTime(), 7, 7, 5,
                        0.5, 0.2, 10, 0.5, z,
                        0.001, 120);
                ...
                for (int i = 0; i < SS.getOrchestratorPolicies().length; i++) {
                    for (int k = 0; k < SS.getSimulationScenarios().length; k++) {
                        ...
                        SimLogger.printLine("The speed level is at: " + z);
                        ...
                        try {
                            ...
                            ScenarioFactory sampleFactory = new SampleScenarioFactory(j, SS.getSimulationTime(), orchestratorPolicy, simScenario, mobilityModel);


                            SimManager manager;

                            // Generate EdgeCloudSim Simulation Manager
                            manager = new SimManager(sampleFactory, j, simScenario, orchestratorPolicy);

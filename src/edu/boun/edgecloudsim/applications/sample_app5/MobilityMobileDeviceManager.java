...
public class MobilityMobileDeviceManager extends MobileDeviceManager {
    ...
    private static final int REQUEST_RECEIVED_BY_MOBILE_DEVICE = BASE + 7;
    ...
    public MobilityMobileDeviceManager() throws Exception {
    }

...
public class MobilityEdgeOrchestrator extends EdgeOrchestrator {
    public static final double MAX_DATA_SIZE=2500;

    private int numberOfHost; //used by load balancer

    public MobilityEdgeOrchestrator(String _policy, String _simScenario) {
    ...
    public int getDeviceToOffload(Task task) {
        ...
        /** Different architectures limits the orchestrator policies here. For example, a highly centralized architecture
         *  cannot deploy the service to edge, and thus all the services are deployed on the cloud. **/
        if(policy.equals("Centralized_Cloud")) {
